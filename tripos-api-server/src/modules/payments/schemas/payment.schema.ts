...
export class Payment {
  ...
  @Prop({ required: true, enum: ['receivable', 'payable', 'refund', 'commission'], index: true }) type!: string;
  ...
  @Prop({ enum: ['pending', 'paid', 'partially_paid', 'overdue', 'cancelled'], default: 'pending', index: true }) status!: string;

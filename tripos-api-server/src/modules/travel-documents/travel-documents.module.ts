...
import { TravelDocument, TravelDocumentSchema } from './schemas/travel-document.schema';
import { TravelDocumentsService } from './services/travel-documents.service';

@Module({
  imports: [MongooseModule.forFeature([{ name: TravelDocument.name, schema: TravelDocumentSchema }])],

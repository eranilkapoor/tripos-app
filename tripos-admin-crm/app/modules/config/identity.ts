...
const identityModules: CrmModule[] = [
  {
    ...
    columns: ["Branch", "Code", "Type", "City", "Manager", "Status"],
    rowMap: ["name", "code", "branchType", "city", "managerUserId", "status"],
    ...
    fields: [
      ...
      { key: "geo", label: "Geo", type: "textarea" },
      { key: "contactPerson", label: "Contact Person", type: "textarea" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "costCenterCode", label: "Cost Center Code" },
      { key: "escalationUserId", label: "Escalation User Ref" },
      { key: "serviceModules", label: "Service Modules", type: "tags" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "defaultBranchIds", label: "Default Branch Refs", type: "tags" },
      {
        key: "defaultDepartmentIds",
        label: "Default Department Refs",
        type: "tags",
      },
      { key: "defaultTeamIds", label: "Default Team Refs", type: "tags" },
